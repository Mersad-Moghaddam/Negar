...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="app-shell">
      <div className="container mx-auto grid min-h-screen max-w-7xl grid-cols-1 gap-3 px-3 pb-4 pt-[6.3rem] sm:px-4 sm:pb-4 sm:pt-[6.4rem] lg:grid-cols-[268px_minmax(0,1fr)] lg:gap-5 lg:px-6 lg:py-5">
