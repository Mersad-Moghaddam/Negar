...
export const messages = {
  ...
  fa: {
    ...
    library: {
      ...
      collectionSummary: '{visible} از {total} کتاب در کتابخانه شما',
      allStatusesHint: 'کتابخانه همیشه شامل همه کتاب‌های ذخیره‌شده است و فیلتر وضعیت فقط نمایش را محدود می‌کند.',
    ...
    books: {
      ...
      editDetailsTitle: 'ویرایش مشخصات',
      editDetailsDescription: 'اطلاعات ذخیره‌شده این کتاب را در کتابخانه به‌روزرسانی کنید.',
